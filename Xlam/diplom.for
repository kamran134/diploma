...
c      read(*,*) a
      ...
      call ddopri5(6,fcn,x,y,xend,eps,hmax,h)
      ...
      implicit real*8(a-h,o-z)
      real*8 y(n),f(n)
      real*8 RHO, psixv, psiyvpsiv 
C 1=x, 2=dx, 3=lambda
      
      psixv=y(4)*y(4)*y(3)*y(3)
      psiyvpsiv=(y(5)*y(3)-y(6))*(y(5)*y(3)-y(6))
      RHO = sqrt(psixv+psiyvpsiv)
    
C    правая часть
      f(1)=y(3)*y(3)*y(4)/RHO
	  f(2)=(y(3)*y(3)*y(5)-y(3)*y(6))/RHO
	  f(3)=-y(3)-(y(5)*y(3)-y(6))/RHO
	  f(4)=0
	  f(5)=0
      f(6)=y(6)-(y(3)*y(4)*y(4)+y(3)*y(5)*y(5)-y(5)*y(6))/RHO
...
C 1=x, 2=y, 3=u, 4=v, 5=px, 6=py, 7=pu, 8=pv
      print *,x,y(1),y(2),y(3),y(4),y(5),y(6)
      return
      end
      ...
      logical reject
      common/stat/nfcn,nstep,naccpt,nrejct
      data nmax/300000/,uround/2.2205d-16/
...
61    k2(i)=(71.d0/57600.d0)*k1(i)-(71.d0/16695.d0)*k3(i)+
     ...
     +    (22.d0/525.d0)*k2(i)
      ...
      do 28 i=1,n
27    k4(i)=(k2(i)-(1.d0/40.d0)*k3(i))*h
      nfcn=nfcn+6
      err=0.
      do 41 i=1,n
