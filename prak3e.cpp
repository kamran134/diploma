...
void fcn(double t, double *y, double *f) {
	...
	f[1]=y[2]*(y[4]*y[2]-y[5])/RHO;								//y^{\cdot}
...
void func(double *f, double *x, int n) {
    ...
    ddopri5(4, fcn, 0.0, y, M_PI_2, M_PI_2, 0.01, true);
    f[0] = y[0];
    f[1] = y[1] + M_PI_2;
}
...
void b_func(double *b, double t) {
	...
	ddopri5(6,fcn,0,y,b[3],1.e-11,1.0e0,0.5e0);
	res[0]=y[0]-0.1386415299798196;//-0.1386315299798196; //x_T
	res[1]=y[1]-8.8869461060126618;//-8.8869461060126618; //y_T
...
int main(int argc, const char *argv[]) {
    ...
    double b[4] = {1, 1, 1, 2}; // x2, p1

    
        newton(b, 2, func);
        double y[4] = {0, b[0], b[1], 0};
        double dz = ddopri5(6, fcn, 0, y, M_PI_2, M_PI_2, 0.01, true);
